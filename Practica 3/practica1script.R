...
print("Del estudio de los datos sobre felicidad en diferentes paises se desprenden algunas conclusiones interesentantes: 1. El país con mayores indices de
...
print("La variable que más correlación directa guarda con el indice de felicidad es el GDP per Capita, aunque como sabemos, esto no implica que el dinero 
